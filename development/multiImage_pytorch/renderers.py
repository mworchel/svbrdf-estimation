...
if __name__ == '__main__':
    ...
    data   = dataset.SvbrdfDataset(data_directory="./data/train", image_size=256, input_image_count=10, used_input_image_count=1, use_augmentation=True, scale_mode='crop')
